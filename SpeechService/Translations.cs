        ...
        public static string Humanize(decimal? value)
        {
            ...
            else
            {
				...
				switch (nextDigit)
				{
					...
					case 3:
						return "environ " + number + " et demi " + order;
					case 4:
						return "près de " + number + " et demi " + order;
					case 5:
						return "autour de " + number + " et demi " + order;
					case 6:
						return "juste au dessus de " + number + " et demi " + order;
					case 7:
						return "largement au delà de " + number + " et demi " + order;
					case 8:
